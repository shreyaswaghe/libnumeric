...
//
inline double RngStream::nextSeed[6] = {12345.0, 12345.0, 12345.0,
...
//-------------------------------------------------------------------------
inline void RngStream::WriteState() const {
	using namespace std;
...
//-------------------------------------------------------------------------
inline void RngStream::WriteStateFull() const {
	using namespace std;
	int i;
...
//-------------------------------------------------------------------------
inline void RngStream::IncreasedPrecis(bool incp) { incPrec = incp; }

//-------------------------------------------------------------------------
inline void RngStream::SetAntithetic(bool a) { anti = a; }
